...
void Complete_analysis() {	
	TString dat_name = "/mnt/ksf9/H2/user/u0148069/share/my.public/Coincidence_creation/Settings_M108.dat";
	...
	ofstream Activity_file(write_dir + output_file);
